...
--
-- Hôte : localhost:3306
-- Généré le : mar. 29 oct. 2024 à 10:31
...
(21, NULL, '2024-07-20 22:08:13', 1, 33),
(22, NULL, '2024-10-18 00:55:02', 1, 35);
...
(24, '2024-00004', '2024-07-20 22:22:57', 1, 2800.000, NULL, 34, 1),
(25, '2024-00005', '2024-07-20 23:24:06', 1, 9600.000, NULL, 33, 1);
...
(80, 25, 1, 6800.000, NULL, NULL, 1),
(97, 24, 1, 2800.000, NULL, NULL, 1),
(97, 25, 1, 2800.000, NULL, NULL, 1);
...
(1, 24, '2024-07-20 22:22:57', NULL),
(1, 25, '2024-07-20 23:24:06', NULL),
...
(51, '001', 'AUTUM', 'COMPOSITION :\r\n                * 07 Pieces  \r\n                * Drap Plat 2.45*2.35\r\n                * Housse De Matela Standard \r\n                * 04 Taies D\'oreiller 70*50\r\n                * 01 Jeté décoratif\r\nDisponible en Drap', 0, 5000.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, NULL, 1, 1, 1),
...
(69, '010', 'CELOSIE', 'Composition Cache Couette 7 Pieces', 0, 6800.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, NULL, 1, 1, 1),
...
(72, '013', 'FLORAL', 'COMPOSITION :\r\n                * 07 Pieces  \r\n                * Cache Couette 2.45*2.35\r\n                * Housse De Matelas Standard \r\n                * 04 Taies D\'oreiller 70*50\r\n                * 01 Jeté Décoratif \r\nDisponible en Drap et Cache Couette', 0, 6800.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, NULL, 1, 1, 1),
(73, '014', 'BERBER BLACK', 'Composition cache couette 7 Pieces', 0, 6900.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, NULL, 1, 1, 1),
...
(76, '017', 'BLEU SISI', 'COMPOSITION :\r\n                * 07 Pieces  \r\n                * Drap Plat  2.45*2.35\r\n                * Housse De Matelas Standard \r\n                * 04 Taies D\'oreiller 70*50\r\n                * 01 Jeté Décoratif \r\nDisponible en Drap', 0, 4500.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, NULL, 1, 1, 1),
...
(99, 'test', 'test', '', 1, 5000.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, NULL, 1, 1, 1);
...
CREATE TABLE `product_sub_cat` (
  ...
  `product_sub_cat_price` decimal(15,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `product_sub_cat` (`product_id`, `sub_cat_id`, `product_sub_cat_price`) VALUES
(52, 1, 6500.00),
(52, 3, 5000.00),
(54, 1, 6800.00),
(54, 3, 5000.00),
...
(5, '4bf69c5ac70188ca5cea7bf7822f952f', 'Bouchama', 'abdou', 'alger', '055573665', 'abdou16bm@yahoo.fr', 'abdou16bm', '$2b$10$ab0RUT0j5coi3XdPPgSX6.Vu4X593UK.3Iw3s/GxwIO4Hv2swOtB.', 3, 16, 1),
...
(33, NULL, 'Laifa', 'Belkis', NULL, '0697556955', NULL, NULL, NULL, 5, 19, 1),
(34, NULL, 'Laifa', 'Belkis', NULL, '0697556955', NULL, NULL, NULL, 5, 19, 1),
(35, '7bc7937d0d6ef805dfc4dcc9d95d874d', 'mohamed', 'test', 'ranobi1130@chysir.com', '0660123212', 'ranobi1130@chysir.com', 'ranobi1130@chysir.com', '$2b$10$xf6pxo6me.UeVhc3fLFKEO91tVxPgd6y/lDeCZA4653kugQtdOZGm', 3, 17, 0);
