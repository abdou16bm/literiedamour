...
//let data_update = input
    ...
    form.parse(req, function (err, fields, files) {
      ...
      if (err) console.log('error',err);
        doc_module.uploadFile('./admin_app/public/img/opinion/',id,files,'main','main','jpg', function (err,count1){

        if (err) console.log(err)

        console.log('count1 : ',count1)
         doc_module.uploadMultiFile('./admin_app/public/img/opinion/',id,files,'jpg', function (err,count2){
...
if (err) console.log('error',err);
           doc_module.uploadFile('./admin_app/public/img/opinion/',result1.insertId,files,'main','main','jpg', function (err,count1){

           if (err) console.log(err)

            console.log('count1 : ',count1)
                doc_module.uploadMultiFile('./admin_app/public/img/opinion/',result1.insertId,files,'jpg', function (err,count2){
