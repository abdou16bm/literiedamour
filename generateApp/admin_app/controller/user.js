...
//let data_update = input
    ...
    form.parse(req, function (err, fields, files) {
        ...
        user_module.user_update(id,data_update,function (err,result1) {
            if (err) console.log('error',err);
            doc_module.uploadFile('./admin_app/public/img/user/',id,files,'main','main','jpg', function (err,count1){

                if (err) console.log(err)

                console.log('count1 : ',count1)
                doc_module.uploadMultiFile('./admin_app/public/img/user/',id,files,'jpg', function (err,count2){
...
//let data_insert = input
    ...
    form.parse(req, function (err, fields, files) {
        ...
        user_module.user_add(data_insert,function (err,result1) {
            if (err) console.log('error',err);
            doc_module.uploadFile('./admin_app/public/img/user/',result1.insertId,files,'main','main','jpg', function (err,count1){

                if (err) console.log(err)

                console.log('count1 : ',count1)
                doc_module.uploadMultiFile('./admin_app/public/img/user/',result1.insertId,files,'jpg', function (err,count2){
